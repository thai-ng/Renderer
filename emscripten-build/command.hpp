...
using VertexParam = std::array<int, 3>;
using FaceParam = std::vector<VertexParam>;
using LightParams = std::array<double, 5>;
using SurfaceParams = std::array<double, 2>;
using CommandParams = mpark::variant<Vector3, PolygonParams, LineParams, RotateParams, FileParam, Color, CameraParams, DepthParams, Point4D, FaceParam, LightParams, LightingMethod, SurfaceParams>;
